...
function Leadform() {
  ...
  const handleSubmit = async () => {
    // Basic validation
    if (!formData.leadType || !formData.firstName || !formData.lastName || !formData.email || !formData.phone) {
    ...
    try {
      const response = await fetch('https://n8n.rochomeloans.com/webhook/leadform', {
        method: 'POST',
        headers: {
            ...
            <div>
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>
                  Lead Type <span style={styles.required}>*</span>
                </label>
                <div style={styles.radioGroup} className="radio-group">
                  {['New Purchase Lead', 'New Refinance Lead'].map((type) => (
              ...
              <div style={styles.row} className="form-row">
                <div style={styles.formGroup}>
                  <label style={styles.label}>
                    Client's First Name <span style={styles.required}>*</span>
                  </label>
                  <input
                    type="text"
                    name="firstName"
                ...
                <div style={styles.formGroup}>
                  <label style={styles.label}>
                    Client's Last Name <span style={styles.required}>*</span>
                  </label>
                  <input
                    type="text"
                    name="lastName"
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>
                  Client's Email <span style={styles.required}>*</span>
                </label>
                <input
                  type="email"
                  name="email"
